            ...
            <div class="col-md-12">
                ...
                <!--codes below has no connection with the database.-->
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="radio"  name="lType" value="indoor" <?php echoChecked($formdata, "lType", "indoor"); ?> ><p style='color:white ; display:inline'>Indoor</p> <br>
                            <input type="radio" name="lType" value="outdoor" <?php echoChecked($formdata, "lType", "outdoor"); ?>><p style='color:white ; display:inline'>Outdoor</p> <br>
                            <input type="radio" name="lType" value="both" <?php echoChecked($formdata, "lType", "both"); ?>><p style='color:white ; display:inline'>Both</p>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="checkbox" name="facilities[]" value="sound" <?php echoCheckedArray($formdata, 'facilities', 'sound'); ?> ><p style='color:white ; display:inline'>Sound Room</p> <br>
                            <input type="checkbox" name="facilities[]" value="screen" <?php echoCheckedArray($formdata, "facilities", "screen"); ?> ><p style='color:white ; display:inline'>Big Screen Room</p> <br>
                            <input type="checkbox" name="facilities[]" value="restaurant" <?php echoCheckedArray($formdata, "facilities", "restaurant"); ?> ><p style='color:white ; display:inline'>Restaurants</p> <br>
                            <input type="checkbox" name="facilities[]" value="bar" <?php echoCheckedArray($formdata, "facilities", "bar"); ?> ><p style='color:white ; display:inline'>Bar </p><br>
                            <input type="checkbox" name="facilities[]" value="disabled" <?php echoCheckedArray($formdata, "facilities", "disabled"); ?> ><p style='color:white ; display:inline'>Disabled Access Toilets </p><br>
                        </div>
                    </div>
                    <div class="form-group">
